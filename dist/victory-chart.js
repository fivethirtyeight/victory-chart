	...
	var VictoryChart = function (_React$Component) {
	  ...
	  _createClass(VictoryChart, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      var _Transitions$getIniti = _victoryCore.Transitions.getInitialTransitionState(this.props.children, nextProps.children);
	    ...
	    value: function getNewChildren(props, childComponents, baseStyle) {
	      ...
	      var getTransitionProps = _victoryCore.Transitions.getTransitionPropsFactory(childComponents, this.state, this.props.animate, function (newState) {
	        return _this2.setState(newState);
	      });
	
	      return childComponents.map(function (child, index) {
	        var transitionProps = getTransitionProps(child.props, child.type, index);
	    ...
	    value: function render() {
	      ...
	      var childComponents = this.state && this.state.nodesWillExit ? _helperMethods2.default.getChildComponents(this.state.oldProps, defaultAxes) : _helperMethods2.default.getChildComponents(this.props, defaultAxes);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _transitions = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _perf = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lineSegment = __webpack_require__(249);
	
	var _lineSegment2 = _interopRequireDefault(_lineSegment);
	
	var _lineLabel = __webpack_require__(252);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _d3Shape = __webpack_require__(250);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	   true ? factory(exports, __webpack_require__(251)) :
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _areaLabel = __webpack_require__(255);
	  ...
	  _createClass(VictoryArea, [{
	    ...
	    value: function render() {
	      ...
	      if (this.props.animate) {
	        ...
	        // make sense to tween. In the future, allow customization of animated
	        // prop whitelist/blacklist?
	        var animateData = (0, _pick2.default)(this.props, ["data", "domain", "height", "padding", "style", "width"]);
	        return _react2.default.createElement(
	          _victoryCore.VictoryAnimation,
	          _extends({}, this.props.animate, { data: animateData }),
	          function (props) {
	            return _react2.default.createElement(VictoryArea, _extends({}, _this2.props, props, { animate: null }));
	          }
	        );
	      }
	      var style = _victoryCore.Helpers.getStyles(this.props.style, defaultStyles, this.props.height, this.props.width);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _omit = __webpack_require__(257);
	...
	var _barLabel = __webpack_require__(259);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pointLabel = __webpack_require__(263);
	...
	var _helperMethods = __webpack_require__(264);
	...
	var VictoryScatter = function (_React$Component) {
	  ...
	  _createClass(VictoryScatter, [{
	    ...
	    value: function getSharedProps(datum, index, calculatedProps) {
	      ...
	      return (0, _assign2.default)({}, { index: index, datum: datum, baseSize: baseSize, symbol: symbol, style: style }, position);
	    }
	  }, {
	    key: "addDataProps",
	...
	VictoryScatter.defaultTransitions = {
	  onExit: {
	    duration: 600,
	    before: function before(datum) {
	      return { opacity: "opacity" in datum ? datum.opacity : 1 };
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pathHelpers = __webpack_require__(262);
	...
	var VictoryGroup = function (_React$Component) {
	  ...
	  _createClass(VictoryGroup, [{
	    ...
	    value: function getCalculatedProps(props, childComponents, style) {
	      ...
	      var baseScale = {
	        x: _scale2.default.getScaleFromProps(props, "x") || "linear",
	        y: _scale2.default.getScaleFromProps(props, "y") || "linear"
	      };
	      var scale = {
	        x: baseScale.x.domain(domain.x).range(range.x),
	        y: baseScale.y.domain(domain.y).range(range.y)
	    ...
	    key: "getXO",
	    value: function getXO(datasets, index, calculatedProps) {
	      var center = (datasets.length - 1) / 2;
	      var totalWidth = this.pixelsToValue(this.props.offset, "x", calculatedProps);
	      return (index - center) * totalWidth;
	    }
	  }, {
	    key: "getLabels",
	    value: function getLabels(index, props, datasets) {
	      if (!props.labels) {
	        return undefined;
	      }
	    ...
	    value: function getNewChildren(props, childComponents, calculatedProps) {
	      ...
	      return childComponents.map(function (child, index) {
	        var xOffset = _this2.getXO(datasets, index, calculatedProps);
	        ...
	        return _react2.default.cloneElement(child, (0, _assign2.default)({
	          ...
	          key: index,
	          labels: _this2.getLabels(index, props, datasets) || child.props.labels,
	    ...
	    value: function render() {
	      var style = _victoryCore.Helpers.getStyles(this.props.style, defaultStyles, this.props.height, this.props.width);
	      var childComponents = _react2.default.Children.toArray(this.props.children);
	      ...
	      var calculatedProps = this.getCalculatedProps(this.props, childComponents, style);
	      var group = _react2.default.createElement(
	        "g",
	        { style: style.parent },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VictoryStack = function (_React$Component) {
	  ...
	  _createClass(VictoryStack, [{
	    ...
	    key: "addLayoutData",
	    value: function addLayoutData(datasets, index, calculatedProps) {
	      var _this2 = this;
	    ...
	    value: function getNewChildren(props, childComponents, calculatedProps) {
	      ...
	      var childProps = this.getChildProps(props, calculatedProps);
	      return childComponents.map(function (child, index) {
	        var data = _this3.addLayoutData(datasets, index, calculatedProps);
	        var style = _wrapper2.default.getChildStyle(child, index, calculatedProps);
	        return _react2.default.cloneElement(child, (0, _assign2.default)({
	          animate: child.props.animate || props.animate,
	          key: index,
	          labels: _this3.getLabels(index, props, datasets) || child.props.labels,
	          labelComponent: props.labelComponent || child.props.labelComponent,
	          style: style,
	          data: data
	        }, childProps));
